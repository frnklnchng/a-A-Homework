...
describe Dessert do
  let(:chef) { double("chef", name: "Franklin") }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["cream", "eggs", "flour", "sugar", "fruit"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Franklin the Great Baker")
      expect(cake.serve).to eq("Chef Franklin the Great Baker has made 10 cakes!")
    end
  end
